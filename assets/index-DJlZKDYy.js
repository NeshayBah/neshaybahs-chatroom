 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var L_;function eb(){if(L_)return bt;L_=1;var r=Symbol.for("react.transitional.element"),t=Symbol.for("react.portal"),n=Symbol.for("react.fragment"),s=Symbol.for("react.strict_mode"),o=Symbol.for("react.profiler"),u=Symbol.for("react.consumer"),f=Symbol.for("react.context"),m=Symbol.for("react.forward_ref"),y=Symbol.for("react.suspense"),p=Symbol.for("react.memo"),E=Symbol.for("react.lazy"),w=Symbol.iterator;function C(D){return D===null||typeof D!="object"?null:(D=w&&D[w]||D["@@iterator"],typeof D=="function"?D:null)}var j={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},Z=Object.assign,tt={};function X(D,$,it){this.props=D,this.context=$,this.refs=tt,this.updater=it||j}X.prototype.isReactComponent={},X.prototype.setState=function(D,$){if(typeof D!="object"&&typeof D!="function"&&D!=null)throw Error("takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,D,$,"setState")},X.prototype.forceUpdate=function(D){this.updater.enqueueForceUpdate(this,D,"forceUpdate")};function st(){}st.prototype=X.prototype;function ut(D,$,it){this.props=D,this.context=$,this.refs=tt,this.updater=it||j}var rt=ut.prototype=new st;rt.constructor=ut,Z(rt,X.prototype),rt.isPureReactComponent=!0;var wt=Array.isArray,vt={H:null,A:null,T:null,S:null,V:null},Lt=Object.prototype.hasOwnProperty;function M(D,$,it,W,dt,It){return it=It.ref,{$$typeof:r,type:D,key:$,ref:it!==void 0?it:null,props:It}}function S(D,$){return M(D.type,$,void 0,void 0,void 0,D.props)}function I(D){return typeof D=="object"&&D!==null&&D.$$typeof===r}function O(D){var $={"=":"=0",":":"=2"};return"$"+D.replace(/[=:]/g,function(it){return $[it]})}var V=/\/+/g;function x(D,$){return typeof D=="object"&&D!==null&&D.key!=null?O(""+D.key):$.toString(36)}function R(){}function ke(D){switch(D.status){case"fulfilled":return D.value;case"rejected":throw D.reason;default:switch(typeof D.status=="string"?D.then(R,R):(D.status="pending",D.then(function($){D.status==="pending"&&(D.status="fulfilled",D.value=$)},function($){D.status==="pending"&&(D.status="rejected",D.reason=$)})),D.status){case"fulfilled":return D.value;case"rejected":throw D.reason}}throw D}function ae(D,$,it,W,dt){var It=typeof D;(It==="undefined"||It==="boolean")&&(D=null);var Tt=!1;if(D===null)Tt=!0;else switch(It){case"bigint":case"string":case"number":Tt=!0;break;case"object":switch(D.$$typeof){case r:case t:Tt=!0;break;case E:return Tt=D._init,ae(Tt(D._payload),$,it,W,dt)}}if(Tt)return dt=dt(D),Tt=W===""?"."+x(D,0):W,wt(dt)?(it="",Tt!=null&&(it=Tt.replace(V,"$&/")+"/"),ae(dt,$,it,"",function(Kn){return Kn})):dt!=null&&(I(dt)&&(dt=S(dt,it+(dt.key==null||D&&D.key===dt.key?"":(""+dt.key).replace(V,"$&/")+"/")+Tt)),$.push(dt)),1;Tt=0;var De=W===""?".":W+":";if(wt(D))for(var Jt=0;Jt<D.length;Jt++)W=D[Jt],It=De+x(W,Jt),Tt+=ae(W,$,it,It,dt);else if(Jt=C(D),typeof Jt=="function")for(D=Jt.call(D),Jt=0;!(W=D.next()).done;)W=W.value,It=De+x(W,Jt++),Tt+=ae(W,$,it,It,dt);else if(It==="object"){if(typeof D.then=="function")return ae(ke(D),$,it,W,dt);throw $=String(D),Error("Objects are not valid as a React child (found: "+($==="[object Object]"?"object with keys {"+Object.keys(D).join(", ")+"}":$)+"). If you meant to render a collection of children, use an array instead.")}return Tt}function H(D,$,it){if(D==null)return D;var W=[],dt=0;return ae(D,W,"","",function(It){return $.call(it,It,dt++)}),W}function nt(D){if(D._status===-1){var $=D._result;$=$(),$.then(function(it){(D._status===0||D._status===-1)&&(D._status=1,D._result=it)},function(it){(D._status===0||D._status===-1)&&(D._status=2,D._result=it)}),D._status===-1&&(D._status=0,D._result=$)}if(D._status===1)return D._result.default;throw D._result}var ht=typeof reportError=="function"?reportError:function(D){if(typeof window=="object"&&typeof window.ErrorEvent=="function"){var $=new window.ErrorEvent("error",{bubbles:!0,cancelable:!0,message:typeof D=="object"&&D!==null&&typeof D.message=="string"?String(D.message):String(D),error:D});if(!window.dispatchEvent($))return}else if(typeof process=="object"&&typeof process.emit=="function"){process.emit("uncaughtException",D);return}console.error(D)};function Bt(){}return bt.Children={map:H,forEach:function(D,$,it){H(D,function(){$.apply(this,arguments)},it)},count:function(D){var $=0;return H(D,function(){$++}),$},toArray:function(D){return H(D,function($){return $})||[]},only:function(D){if(!I(D))throw Error("React.Children.only expected to receive a single React element child.");return D}},bt.Component=X,bt.Fragment=n,bt.Profiler=o,bt.PureComponent=ut,bt.StrictMode=s,bt.Suspense=y,bt.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=vt,bt.__COMPILER_RUNTIME={__proto__:null,c:function(D){return vt.H.useMemoCache(D)}},bt.cache=function(D){return function(){return D.apply(null,arguments)}},bt.cloneElement=function(D,$,it){if(D==null)throw Error("The argument must be a React element, but you passed "+D+".");var W=Z({},D.props),dt=D.key,It=void 0;if($!=null)for(Tt in $.ref!==void 0&&(It=void 0),$.key!==void 0&&(dt=""+$.key),$)!Lt.call($,Tt)||Tt==="key"||Tt==="__self"||Tt==="__source"||Tt==="ref"&&$.ref===void 0||(W[Tt]=$[Tt]);var Tt=arguments.length-2;if(Tt===1)W.children=it;else if(1<Tt){for(var De=Array(Tt),Jt=0;Jt<Tt;Jt++)De[Jt]=arguments[Jt+2];W.children=De}return M(D.type,dt,void 0,void 0,It,W)},bt.createContext=function(D){return D={$$typeof:f,_currentValue:D,_currentValue2:D,_threadCount:0,Provider:null,Consumer:null},D.Provider=D,D.Consumer={$$typeof:u,_context:D},D},bt.createElement=function(D,$,it){var W,dt={},It=null;if($!=null)for(W in $.key!==void 0&&(It=""+$.key),$)Lt.call($,W)&&W!=="key"&&W!=="__self"&&W!=="__source"&&(dt[W]=$[W]);var Tt=arguments.length-2;if(Tt===1)dt.children=it;else if(1<Tt){for(var De=Array(Tt),Jt=0;Jt<Tt;Jt++)De[Jt]=arguments[Jt+2];dt.children=De}if(D&&D.defaultProps)for(W in Tt=D.defaultProps,Tt)dt[W]===void 0&&(dt[W]=Tt[W]);return M(D,It,void 0,void 0,null,dt)},bt.createRef=function(){return{current:null}},bt.forwardRef=function(D){return{$$typeof:m,render:D}},bt.isValidElement=I,bt.lazy=function(D){return{$$typeof:E,_payload:{_status:-1,_result:D},_init:nt}},bt.memo=function(D,$){return{$$typeof:p,type:D,compare:$===void 0?null:$}},bt.startTransition=function(D){var $=vt.T,it={};vt.T=it;try{var W=D(),dt=vt.S;dt!==null&&dt(it,W),typeof W=="object"&&W!==null&&typeof W.then=="function"&&W.then(Bt,ht)}catch(It){ht(It)}finally{vt.T=$}},bt.unstable_useCacheRefresh=function(){return vt.H.useCacheRefresh()},bt.use=function(D){return vt.H.use(D)},bt.useActionState=function(D,$,it){return vt.H.useActionState(D,$,it)},bt.useCallback=function(D,$){return vt.H.useCallback(D,$)},bt.useContext=function(D){return vt.H.useContext(D)},bt.useDebugValue=function(){},bt.useDeferredValue=function(D,$){return vt.H.useDeferredValue(D,$)},bt.useEffect=function(D,$,it){var W=vt.H;if(typeof it=="function")throw Error("useEffect CRUD overload is not enabled in this build of React.");return W.useEffect(D,$)},bt.useId=function(){return vt.H.useId()},bt.useImperativeHandle=function(D,$,it){return vt.H.useImperativeHandle(D,$,it)},bt.useInsertionEffect=function(D,$){return vt.H.useInsertionEffect(D,$)},bt.useLayoutEffect=function(D,$){return vt.H.useLayoutEffect(D,$)},bt.useMemo=function(D,$){return vt.H.useMemo(D,$)},bt.useOptimistic=function(D,$){return vt.H.useOptimistic(D,$)},bt.useReducer=function(D,$,it){return vt.H.useReducer(D,$,it)},bt.useRef=function(D){return vt.H.useRef(D)},bt.useState=function(D){return vt.H.useState(D)},bt.useSyncExternalStore=function(D,$,it){return vt.H.useSyncExternalStore(D,$,it)},bt.useTransition=function(){return vt.H.useTransition()},bt.version="19.1.1",bt}var z_;function Em(){return z_||(z_=1,Dd.exports=eb()),Dd.exports}var At=Em(),Nd={exports:{}},Al={},Od={exports:{}},Vd={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var B_;function nb(){return B_||(B_=1,(function(r){function t(H,nt){var ht=H.length;H.push(nt);t:for(;0<ht;){var Bt=ht-1>>>1,D=H[Bt];if(0<o(D,nt))H[Bt]=nt,H[ht]=D,ht=Bt;else break t}}function n(H){return H.length===0?null:H[0]}function s(H){if(H.length===0)return null;var nt=H[0],ht=H.pop();if(ht!==nt){H[0]=ht;t:for(var Bt=0,D=H.length,$=D>>>1;Bt<$;){var it=2*(Bt+1)-1,W=H[it],dt=it+1,It=H[dt];if(0>o(W,ht))dt<D&&0>o(It,W)?(H[Bt]=It,H[dt]=ht,Bt=dt):(H[Bt]=W,H[it]=ht,Bt=it);else if(dt<D&&0>o(It,ht))H[Bt]=It,H[dt]=ht,Bt=dt;else break t}}return nt}function o(H,nt){var ht=H.sortIndex-nt.sortIndex;return ht!==0?ht:H.id-nt.id}if(r.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var u=performance;r.unstable_now=function(){return u.now()}}else{var f=Date,m=f.now();r.unstable_now=function(){return f.now()-m}}var y=[],p=[],E=1,w=null,C=3,j=!1,Z=!1,tt=!1,X=!1,st=typeof setTimeout=="function"?setTimeout:null,ut=typeof clearTimeout=="function"?clearTimeout:null,rt=typeof setImmediate<"u"?setImmediate:null;function wt(H){for(var nt=n(p);nt!==null;){if(nt.callback===null)s(p);else if(nt.startTime<=H)s(p),nt.sortIndex=nt.expirationTime,t(y,nt);else break;nt=n(p)}}function vt(H){if(tt=!1,wt(H),!Z)if(n(y)!==null)Z=!0,Lt||(Lt=!0,x());else{var nt=n(p);nt!==null&&ae(vt,nt.startTime-H)}}var Lt=!1,M=-1,S=5,I=-1;function O(){return X?!0:!(r.unstable_now()-I<S)}function V(){if(X=!1,Lt){var H=r.unstable_now();I=H;var nt=!0;try{t:{Z=!1,tt&&(tt=!1,ut(M),M=-1),j=!0;var ht=C;try{e:{for(wt(H),w=n(y);w!==null&&!(w.expirationTime>H&&O());){var Bt=w.callback;if(typeof Bt=="function"){w.callback=null,C=w.priorityLevel;var D=Bt(w.expirationTime<=H);if(H=r.unstable_now(),typeof D=="function"){w.callback=D,wt(H),nt=!0;break e}w===n(y)&&s(y),wt(H)}else s(y);w=n(y)}if(w!==null)nt=!0;else{var $=n(p);$!==null&&ae(vt,$.startTime-H),nt=!1}}break t}finally{w=null,C=ht,j=!1}nt=void 0}}finally{nt?x():Lt=!1}}}var x;if(typeof rt=="function")x=function(){rt(V)};else if(typeof MessageChannel<"u"){var R=new MessageChannel,ke=R.port2;R.port1.onmessage=V,x=function(){ke.postMessage(null)}}else x=function(){st(V,0)};function ae(H,nt){M=st(function(){H(r.unstable_now())},nt)}r.unstable_IdlePriority=5,r.unstable_ImmediatePriority=1,r.unstable_LowPriority=4,r.unstable_NormalPriority=3,r.unstable_Profiling=null,r.unstable_UserBlockingPriority=2,r.unstable_cancelCallback=function(H){H.callback=null},r.unstable_forceFrameRate=function(H){0>H||125<H?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):S=0<H?Math.floor(1e3/H):5},r.unstable_getCurrentPriorityLevel=function(){return C},r.unstable_next=function(H){switch(C){case 1:case 2:case 3:var nt=3;break;default:nt=C}var ht=C;C=nt;try{return H()}finally{C=ht}},r.unstable_requestPaint=function(){X=!0},r.unstable_runWithPriority=function(H,nt){switch(H){case 1:case 2:case 3:case 4:case 5:break;default:H=3}var ht=C;C=H;try{return nt()}finally{C=ht}},r.unstable_scheduleCallback=function(H,nt,ht){var Bt=r.unstable_now();switch(typeof ht=="object"&&ht!==null?(ht=ht.delay,ht=typeof ht=="number"&&0<ht?Bt+ht:Bt):ht=Bt,H){case 1:var D=-1;break;case 2:D=250;break;case 5:D=1073741823;break;case 4:D=1e4;break;default:D=5e3}return D=ht+D,H={id:E++,callback:nt,priorityLevel:H,startTime:ht,expirationTime:D,sortIndex:-1},ht>Bt?(H.sortIndex=ht,t(p,H),n(y)===null&&H===n(p)&&(tt?(ut(M),M=-1):tt=!0,ae(vt,ht-Bt))):(H.sortIndex=D,t(y,H),Z||j||(Z=!0,Lt||(Lt=!0,x()))),H},r.unstable_shouldYield=O,r.unstable_wrapCallback=function(H){var nt=C;return function(){var ht=C;C=nt;try{return H.apply(this,arguments)}finally{C=ht}}}})(Vd)),Vd}var q_;function ib(){return q_||(q_=1,Od.exports=nb()),Od.exports}var Md={exports:{}},Ke={};/**
 * @license React
...
</defs>`,Z.innerText="Preview backend running in this workspace."),Z.setAttribute("id",j)}document.readyState==="loading"?window.addEventListener("DOMContentLoaded",w):w()}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const so=V1;function FT(r,t={}){let n=r;typeof t!="object"&&(t={name:t});const s={name:Jd,automaticDataCollectionEnabled:!0,...t},o=s.name;if(typeof o!="string"||!o)throw kr.create("bad-app-name",{appName:String(o)});if(n||(n=PT()),!n)throw kr.create("no-options");const u=jc.get(o);if(u){if(Lr(n,u.options)&&Lr(s,u.config))return u;throw kr.create("duplicate-app",{appName:o})}const f=new Hb(o);for(const y of Wd.values())f.addComponent(y);const m=new k1(n,s,f);return jc.set(o,m),m}function Sm(r=Jd){const t=jc.get(r);if(!t&&r===Jd&&PT())return FT();if(!t)throw kr.create("no-app",{appName:r});return t}function Mn(r,t,n){let s=M1[r]??r;n&&(s+=`-${n}`);const o=s.match(/\s|\//),u=t.match(/\s|\//);if(o||u){const f=[`Unable to register library "${s}" with version "${t}":`];o&&f.push(`library name "${s}" contains illegal characters (whitespace or "/")`),o&&u&&f.push("and"),u&&f.push(`version name "${t}" contains illegal characters (whitespace or "/")`),Zi.warn(f.join(" "));return}_i(new Fn(`${s}-version`,()=>({library:s,version:t}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function pt(r,t,n){let s="Unexpected state";typeof t=="string"?s=t:n=t,WT(r,s,n)}function WT(r,t,n){let s=`FIRESTORE (${ao}) INTERNAL ASSERTION FAILED: ${t} (ID: ${r.toString(16)})`;if(n!==void 0)try{s+=" CONTEXT: "+JSON.stringify(n)}catch{s+=" CONTEXT: "+n}throw Ji(s),new Error(s)}function Ht(r,t,n,s){let o="Unexpected state";typeof n=="string"?o=n:s=n,r||WT(t,o,s)}function St(r,t){return r}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function oo(r){if(r.code!==Q.FAILED_PRECONDITION||r.message!==uw)throw r;ot("LocalStore","Unexpectedly lost primary lease")}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Qc{constructor(t,n){this.position=t,this.inclusive=n}}function Ev(r,t,n){let s=0;for(let o=0;o<r.position.length;o++){const u=t[o],f=r.position[o];if(u.field.isKeyField()?s=ft.comparator(ft.fromName(f.referenceValue),n.key):s=Wa(f,n.data.field(u.field)),u.dir==="desc"&&(s*=-1),s!==0)break}return s}function Av(r,t){if(r===null)return t===null;if(t===null||r.inclusive!==t.inclusive||r.position.length!==t.position.length)return!1;for(let n=0;n<r.position.length;n++)if(!vi(r.position[n],t.position[n]))return!1;return!0}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Pw=new se(ft.comparator);function Wi(){return Pw}const AE=new se(ft.comparator);function bl(...r){let t=AE;for(const n of r)t=t.insert(n.key,n);return t}function SE(r){let t=AE;return r.forEach(((n,s)=>t=t.insert(n,s.overlayedDocument))),t}function Ds(){return Nl()}function bE(){return Nl()}function Nl(){return new Gs((r=>r.toString()),((r,t)=>r.isEqual(t)))}const xw=new se(ft.comparator),kw=new Ce(ft.comparator);function Mt(...r){let t=kw;for(const n of r)t=t.add(n);return t}const Uw=new Ce(Vt);function Lw(){return Uw}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class yh{constructor(t,n,s,o,u){this.snapshotVersion=t,this.targetChanges=n,this.targetMismatches=s,this.documentUpdates=o,this.resolvedLimboDocuments=u}static createSynthesizedRemoteEventForCurrentChange(t,n,s){const o=new Map;return o.set(t,Xl.createSynthesizedTargetChangeForCurrentChange(t,n,s)),new yh(Et.min(),o,new se(Vt),Wi(),Mt())}}class Xl{constructor(t,n,s,o,u){this.resumeToken=t,this.current=n,this.addedDocuments=s,this.modifiedDocuments=o,this.removedDocuments=u}static createSynthesizedTargetChangeForCurrentChange(t,n,s){return new Xl(s,n,Mt(),Mt(),Mt())}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class OR{constructor(){this.overlays=new se(ft.comparator),this.qr=new Map}getOverlay(t,n){return Y.resolve(this.overlays.get(n))}getOverlays(t,n){const s=Ds();return Y.forEach(n,(o=>this.getOverlay(t,o).next((u=>{u!==null&&s.set(o,u)})))).next((()=>s))}saveOverlays(t,n,s){return s.forEach(((o,u)=>{this.St(t,n,u)})),Y.resolve()}removeOverlaysForBatchId(t,n,s){const o=this.qr.get(s);return o!==void 0&&(o.forEach((u=>this.overlays=this.overlays.remove(u))),this.qr.delete(s)),Y.resolve()}getOverlaysForCollection(t,n,s){const o=Ds(),u=n.length+1,f=new ft(n.child("")),m=this.overlays.getIteratorFrom(f);for(;m.hasNext();){const y=m.getNext().value,p=y.getKey();if(!n.isPrefixOf(p.path))break;p.path.length===u&&y.largestBatchId>s&&o.set(y.getKey(),y)}return Y.resolve(o)}getOverlaysForCollectionGroup(t,n,s,o){let u=new se(((p,E)=>p-E));const f=this.overlays.getIterator();for(;f.hasNext();){const p=f.getNext().value;if(p.getKey().getCollectionGroup()===n&&p.largestBatchId>s){let E=u.get(p.largestBatchId);E===null&&(E=Ds(),u=u.insert(p.largestBatchId,E)),E.set(p.getKey(),p)}}const m=Ds(),y=u.getIterator();for(;y.hasNext()&&(y.getNext().value.forEach(((p,E)=>m.set(p,E))),!(m.size()>=o)););return Y.resolve(m)}St(t,n,s){const o=this.overlays.get(s.key);if(o!==null){const f=this.qr.get(o.largestBatchId).delete(s.key);this.qr.set(o.largestBatchId,f)}this.overlays=this.overlays.insert(s.key,new Xw(n,s));let u=this.qr.get(n);u===void 0&&(u=Mt(),this.qr.set(n,u)),this.qr.set(n,u.add(s.key))}}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class zR{constructor(){this.Rs=!1,this.Vs=!1,this.fs=100,this.gs=(function(){return Ib()?8:hw(Ze())>0?6:4})()}initialize(t,n){this.ps=t,this.indexManager=n,this.Rs=!0}getDocumentsMatchingQuery(t,n,s,o){const u={result:null};return this.ys(t,n).next((f=>{u.result=f})).next((()=>{if(!u.result)return this.ws(t,n,o,s).next((f=>{u.result=f}))})).next((()=>{if(u.result)return;const f=new LR;return this.Ss(t,n,f).next((m=>{if(u.result=m,this.Vs)return this.bs(t,n,f,m.size)}))})).next((()=>u.result))}bs(t,n,s,o){return s.documentReadCount<this.fs?(Ba()<=Ot.DEBUG&&ot("QueryEngine","SDK will not create cache indexes for query:",qa(n),"since it only creates cache indexes for collection contains","more than or equal to",this.fs,"documents"),Y.resolve()):(Ba()<=Ot.DEBUG&&ot("QueryEngine","Query:",qa(n),"scans",s.documentReadCount,"local documents and returns",o,"documents as results."),s.documentReadCount>this.gs*o?(Ba()<=Ot.DEBUG&&ot("QueryEngine","The SDK decides to create cache indexes for query:",qa(n),"as using cache indexes may help improve performance."),this.indexManager.createTargetIndexes(t,hi(n))):Y.resolve())}ys(t,n){if(bv(n))return Y.resolve(null);let s=hi(n);return this.indexManager.getIndexType(t,s).next((o=>o===0?null:(n.limit!==null&&o===1&&(n=Kc(n,null,"F"),s=hi(n)),this.indexManager.getDocumentsMatchingTarget(t,s).next((u=>{const f=Mt(...u);return this.ps.getDocuments(t,f).next((m=>this.indexManager.getMinOffset(t,s).next((y=>{const p=this.Ds(n,m);return this.Cs(n,p,f,y.readTime)?this.ys(t,Kc(n,null,"F")):this.vs(t,p,n,y)}))))})))))}ws(t,n,s,o){return bv(n)||o.isEqual(Et.min())?Y.resolve(null):this.ps.getDocuments(t,s).next((u=>{const f=this.Ds(n,u);return this.Cs(n,f,s,o)?Y.resolve(null):(Ba()<=Ot.DEBUG&&ot("QueryEngine","Re-using previous result from %s to execute query: %s",o.toString(),qa(n)),this.vs(t,f,n,aw(o,xl)).next((m=>m)))}))}Ds(t,n){let s=new Ce(EE(t));return n.forEach(((o,u)=>{mh(t,u)&&(s=s.add(u))})),s}Cs(t,n,s,o){if(t.limit===null)return!1;if(s.size!==n.size)return!0;const u=t.limitType==="F"?n.last():n.first();return!!u&&(u.hasPendingWrites||u.version.compareTo(o)>0)}Ss(t,n,s){return Ba()<=Ot.DEBUG&&ot("QueryEngine","Using full collection scan to execute query:",qa(n)),this.ps.getDocumentsMatchingQuery(t,n,zr.min(),s)}vs(t,n,s,o){return this.ps.getDocumentsMatchingQuery(t,s,o).next((u=>(n.forEach((f=>{u=u.insert(f.key,f)})),u)))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const zm="LocalStore",BR=3e8;class qR{constructor(t,n,s,o){this.persistence=t,this.Fs=n,this.serializer=o,this.Ms=new se(Vt),this.xs=new Gs((u=>Dm(u)),Nm),this.Os=new Map,this.Ns=t.getRemoteDocumentCache(),this.Pi=t.getTargetCache(),this.Ii=t.getBundleCache(),this.Bs(s)}Bs(t){this.documentOverlayCache=this.persistence.getDocumentOverlayCache(t),this.indexManager=this.persistence.getIndexManager(t),this.mutationQueue=this.persistence.getMutationQueue(t,this.indexManager),this.localDocuments=new DR(this.Ns,this.mutationQueue,this.documentOverlayCache,this.indexManager),this.Ns.setIndexManager(this.indexManager),this.Fs.initialize(this.localDocuments,this.indexManager)}collectGarbage(t){return this.persistence.runTransaction("Collect garbage","readwrite-primary",(n=>t.collect(n,this.Ms)))}}function jR(r,t,n,s){return new qR(r,t,n,s)}async function GE(r,t){const n=St(r);return await n.persistence.runTransaction("Handle user change","readonly",(s=>{let o;return n.mutationQueue.getAllMutationBatches(s).next((u=>(o=u,n.Bs(t),n.mutationQueue.getAllMutationBatches(s)))).next((u=>{const f=[],m=[];let y=Mt();for(const p of o){f.push(p.batchId);for(const E of p.mutations)y=y.add(E.key)}for(const p of u){m.push(p.batchId);for(const E of p.mutations)y=y.add(E.key)}return n.localDocuments.getDocuments(s,y).next((p=>({Ls:p,removedBatchIds:f,addedBatchIds:m})))}))}))}function HR(r,t){const n=St(r);return n.persistence.runTransaction("Acknowledge batch","readwrite-primary",(s=>{const o=t.batch.keys(),u=n.Ns.newChangeBuffer({trackRemovals:!0});return(function(m,y,p,E){const w=p.batch,C=w.keys();let j=Y.resolve();return C.forEach((Z=>{j=j.next((()=>E.getEntry(y,Z))).next((tt=>{const X=p.docVersions.get(Z);Ht(X!==null,48541),tt.version.compareTo(X)<0&&(w.applyToRemoteDocument(tt,p),tt.isValidDocument()&&(tt.setReadTime(p.commitVersion),E.addEntry(tt)))}))})),j.next((()=>m.mutationQueue.removeMutationBatch(y,w)))})(n,s,t,u).next((()=>u.apply(s))).next((()=>n.mutationQueue.performConsistencyCheck(s))).next((()=>n.documentOverlayCache.removeOverlaysForBatchId(s,o,t.batch.batchId))).next((()=>n.localDocuments.recalculateAndSaveOverlaysForDocumentKeys(s,(function(m){let y=Mt();for(let p=0;p<m.mutationResults.length;++p)m.mutationResults[p].transformResults.length>0&&(y=y.add(m.batch.mutations[p].key));return y})(t)))).next((()=>n.localDocuments.getDocuments(s,o)))}))}function QE(r){const t=St(r);return t.persistence.runTransaction("Get last remote snapshot version","readonly",(n=>t.Pi.getLastRemoteSnapshotVersion(n)))}function FR(r,t){const n=St(r),s=t.snapshotVersion;let o=n.Ms;return n.persistence.runTransaction("Apply remote event","readwrite-primary",(u=>{const f=n.Ns.newChangeBuffer({trackRemovals:!0});o=n.Ms;const m=[];t.targetChanges.forEach(((E,w)=>{const C=o.get(w);if(!C)return;m.push(n.Pi.removeMatchingKeys(u,E.removedDocuments,w).next((()=>n.Pi.addMatchingKeys(u,E.addedDocuments,w))));let j=C.withSequenceNumber(u.currentSequenceNumber);t.targetMismatches.get(w)!==null?j=j.withResumeToken(Fe.EMPTY_BYTE_STRING,Et.min()).withLastLimboFreeSnapshotVersion(Et.min()):E.resumeToken.approximateByteSize()>0&&(j=j.withResumeToken(E.resumeToken,s)),o=o.insert(w,j),(function(tt,X,st){return tt.resumeToken.approximateByteSize()===0||X.snapshotVersion.toMicroseconds()-tt.snapshotVersion.toMicroseconds()>=BR?!0:st.addedDocuments.size+st.modifiedDocuments.size+st.removedDocuments.size>0})(C,j,E)&&m.push(n.Pi.updateTargetData(u,j))}));let y=Wi(),p=Mt();if(t.documentUpdates.forEach((E=>{t.resolvedLimboDocuments.has(E)&&m.push(n.persistence.referenceDelegate.updateLimboDocument(u,E))})),m.push(GR(u,f,t.documentUpdates).next((E=>{y=E.ks,p=E.qs}))),!s.isEqual(Et.min())){const E=n.Pi.getLastRemoteSnapshotVersion(u).next((w=>n.Pi.setTargetsMetadata(u,u.currentSequenceNumber,s)));m.push(E)}return Y.waitFor(m).next((()=>f.apply(u))).next((()=>n.localDocuments.getLocalViewOfDocuments(u,y,p))).next((()=>y))})).then((u=>(n.Ms=o,u)))}function GR(r,t,n){let s=Mt(),o=Mt();return n.forEach((u=>s=s.add(u))),t.getEntries(r,s).next((u=>{let f=Wi();return n.forEach(((m,y)=>{const p=u.get(m);y.isFoundDocument()!==p.isFoundDocument()&&(o=o.add(m)),y.isNoDocument()&&y.version.isEqual(Et.min())?(t.removeEntry(m,y.readTime),f=f.insert(m,y)):!p.isValidDocument()||y.version.compareTo(p.version)>0||y.version.compareTo(p.version)===0&&p.hasPendingWrites?(t.addEntry(y),f=f.insert(m,y)):ot(zm,"Ignoring outdated watch update for ",m,". Current version:",p.version," Watch version:",y.version)})),{ks:f,qs:o}}))}function QR(r,t){const n=St(r);return n.persistence.runTransaction("Get next mutation batch","readonly",(s=>(t===void 0&&(t=Rm),n.mutationQueue.getNextMutationBatchAfterBatchId(s,t))))}function KR(r,t){const n=St(r);return n.persistence.runTransaction("Allocate target","readwrite",(s=>{let o;return n.Pi.getTargetData(s,t).next((u=>u?(o=u,Y.resolve(o)):n.Pi.allocateTargetId(s).next((f=>(o=new Pr(t,f,"TargetPurposeListen",s.currentSequenceNumber),n.Pi.addTargetData(s,o).next((()=>o)))))))})).then((s=>{const o=n.Ms.get(s.targetId);return(o===null||s.snapshotVersion.compareTo(o.snapshotVersion)>0)&&(n.Ms=n.Ms.insert(s.targetId,s),n.xs.set(t,s.targetId)),s}))}async function hm(r,t,n){const s=St(r),o=s.Ms.get(t),u=n?"readwrite":"readwrite-primary";try{n||await s.persistence.runTransaction("Release target",u,(f=>s.persistence.referenceDelegate.removeTarget(f,o)))}catch(f){if(!lo(f))throw f;ot(zm,`Failed to update sequence numbers for target ${t}: ${f}`)}s.Ms=s.Ms.remove(t),s.xs.delete(o.target)}function Uv(r,t,n){const s=St(r);let o=Et.min(),u=Mt();return s.persistence.runTransaction("Execute query","readwrite",(f=>(function(y,p,E){const w=St(y),C=w.xs.get(E);return C!==void 0?Y.resolve(w.Ms.get(C)):w.Pi.getTargetData(p,E)})(s,f,hi(t)).next((m=>{if(m)return o=m.lastLimboFreeSnapshotVersion,s.Pi.getMatchingKeysForTargetId(f,m.targetId).next((y=>{u=y}))})).next((()=>s.Fs.getDocumentsMatchingQuery(f,t,n?o:Et.min(),n?u:Mt()))).next((m=>(YR(s,Vw(t),m),{documents:m,Qs:u})))))}function YR(r,t,n){let s=r.Os.get(t)||Et.min();n.forEach(((o,u)=>{u.readTime.compareTo(s)>0&&(s=u.readTime)})),r.Os.set(t,s)}class Lv{constructor(){this.activeTargetIds=Lw()}zs(t){this.activeTargetIds=this.activeTargetIds.add(t)}js(t){this.activeTargetIds=this.activeTargetIds.delete(t)}Gs(){const t={activeTargetIds:this.activeTargetIds.toArray(),updateTimeMs:Date.now()};return JSON.stringify(t)}}class XR{constructor(){this.Mo=new Lv,this.xo={},this.onlineStateHandler=null,this.sequenceNumberHandler=null}addPendingMutation(t){}updateMutationState(t,n,s){}addLocalQueryTarget(t,n=!0){return n&&this.Mo.zs(t),this.xo[t]||"not-current"}updateQueryState(t,n,s){this.xo[t]=n}removeLocalQueryTarget(t){this.Mo.js(t)}isLocalQueryTarget(t){return this.Mo.activeTargetIds.has(t)}clearQueryState(t){delete this.xo[t]}getAllActiveQueryTargets(){return this.Mo.activeTargetIds}isActiveQueryTarget(t){return this.Mo.activeTargetIds.has(t)}start(){return this.Mo=new Lv,Promise.resolve()}handleUserChange(t,n,s){}setOnlineState(t){}shutdown(){}writeSequenceNumber(t){}notifyBundleLoaded(t){}}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ye="WebChannelConnection";class tI extends JR{constructor(t){super(t),this.c_=[],this.forceLongPolling=t.forceLongPolling,this.autoDetectLongPolling=t.autoDetectLongPolling,this.useFetchStreams=t.useFetchStreams,this.longPollingOptions=t.longPollingOptions}Jo(t,n,s,o,u){const f=fm();return new Promise(((m,y)=>{const p=new YT;p.setWithCredentials(!0),p.listenOnce(XT.COMPLETE,(()=>{try{switch(p.getLastErrorCode()){case Oc.NO_ERROR:const w=p.getResponseJson();ot(Ye,`XHR for RPC '${t}' ${f} received:`,JSON.stringify(w)),m(w);break;case Oc.TIMEOUT:ot(Ye,`RPC '${t}' ${f} timed out`),y(new at(Q.DEADLINE_EXCEEDED,"Request time out"));break;case Oc.HTTP_ERROR:const C=p.getStatus();if(ot(Ye,`RPC '${t}' ${f} failed with status:`,C,"response text:",p.getResponseText()),C>0){let j=p.getResponseJson();Array.isArray(j)&&(j=j[0]);const Z=j?.error;if(Z&&Z.status&&Z.message){const tt=(function(st){const ut=st.toLowerCase().replace(/_/g,"-");return Object.values(Q).indexOf(ut)>=0?ut:Q.UNKNOWN})(Z.status);y(new at(tt,Z.message))}else y(new at(Q.UNKNOWN,"Server responded with status "+p.getStatus()))}else y(new at(Q.UNAVAILABLE,"Connection failed."));break;default:pt(9055,{l_:t,streamId:f,h_:p.getLastErrorCode(),P_:p.getLastError()})}}finally{ot(Ye,`RPC '${t}' ${f} completed.`)}}));const E=JSON.stringify(o);ot(Ye,`RPC '${t}' ${f} sending request:`,o),p.send(n,"POST",E,s,15)}))}T_(t,n,s){const o=fm(),u=[this.Uo,"/","google.firestore.v1.Firestore","/",t,"/channel"],f=JT(),m=ZT(),y={httpSessionIdParam:"gsessionid",initMessageHeaders:{},messageUrlParams:{database:`projects/${this.databaseId.projectId}/databases/${this.databaseId.database}`},sendRawJson:!0,supportsCrossDomainXhr:!0,internalChannelParams:{forwardChannelRequestTimeoutMs:6e5},forceLongPolling:this.forceLongPolling,detectBufferingProxy:this.autoDetectLongPolling},p=this.longPollingOptions.timeoutSeconds;p!==void 0&&(y.longPollingTimeout=Math.round(1e3*p)),this.useFetchStreams&&(y.useFetchStreams=!0),this.jo(y.initMessageHeaders,n,s),y.encodeInitMessageHeaders=!0;const E=u.join("");ot(Ye,`Creating RPC '${t}' stream ${o}: ${E}`,y);const w=f.createWebChannel(E,y);this.I_(w);let C=!1,j=!1;const Z=new WR({Yo:X=>{j?ot(Ye,`Not sending because RPC '${t}' stream ${o} is closed:`,X):(C||(ot(Ye,`Opening RPC '${t}' stream ${o} transport.`),w.open(),C=!0),ot(Ye,`RPC '${t}' stream ${o} sending:`,X),w.send(X))},Zo:()=>w.close()}),tt=(X,st,ut)=>{X.listen(st,(rt=>{try{ut(rt)}catch(wt){setTimeout((()=>{throw wt}),0)}}))};return tt(w,Sl.EventType.OPEN,(()=>{j||(ot(Ye,`RPC '${t}' stream ${o} transport opened.`),Z.o_())})),tt(w,Sl.EventType.CLOSE,(()=>{j||(j=!0,ot(Ye,`RPC '${t}' stream ${o} transport closed`),Z.a_(),this.E_(w))})),tt(w,Sl.EventType.ERROR,(X=>{j||(j=!0,Za(Ye,`RPC '${t}' stream ${o} transport errored. Name:`,X.name,"Message:",X.message),Z.a_(new at(Q.UNAVAILABLE,"The operation could not be completed")))})),tt(w,Sl.EventType.MESSAGE,(X=>{if(!j){const st=X.data[0];Ht(!!st,16349);const ut=st,rt=ut?.error||ut[0]?.error;if(rt){ot(Ye,`RPC '${t}' stream ${o} received error:`,rt);const wt=rt.status;let vt=(function(S){const I=Te[S];if(I!==void 0)return ME(I)})(wt),Lt=rt.message;vt===void 0&&(vt=Q.INTERNAL,Lt="Unknown error status: "+wt+" with message "+rt.message),j=!0,Z.a_(new at(vt,Lt)),w.close()}else ot(Ye,`RPC '${t}' stream ${o} received:`,st),Z.u_(st)}})),tt(m,$T.STAT_EVENT,(X=>{X.stat===tm.PROXY?ot(Ye,`RPC '${t}' stream ${o} detected buffering proxy`):X.stat===tm.NOPROXY&&ot(Ye,`RPC '${t}' stream ${o} detected no buffering proxy`)})),setTimeout((()=>{Z.__()}),0),Z}terminate(){this.c_.forEach((t=>t.close())),this.c_=[]}I_(t){this.c_.push(t)}E_(t){this.c_=this.c_.filter((n=>n===t))}}function jd(){return typeof document<"u"?document:null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Qa{static emptySet(t){return new Qa(t.comparator)}constructor(t){this.comparator=t?(n,s)=>t(n,s)||ft.comparator(n.key,s.key):(n,s)=>ft.comparator(n.key,s.key),this.keyedMap=bl(),this.sortedSet=new se(this.comparator)}has(t){return this.keyedMap.get(t)!=null}get(t){return this.keyedMap.get(t)}first(){return this.sortedSet.minKey()}last(){return this.sortedSet.maxKey()}isEmpty(){return this.sortedSet.isEmpty()}indexOf(t){const n=this.keyedMap.get(t);return n?this.sortedSet.indexOf(n):-1}get size(){return this.sortedSet.size}forEach(t){this.sortedSet.inorderTraversal(((n,s)=>(t(n),!1)))}add(t){const n=this.delete(t.key);return n.copy(n.keyedMap.insert(t.key,t),n.sortedSet.insert(t,null))}delete(t){const n=this.get(t);return n?this.copy(this.keyedMap.remove(t),this.sortedSet.remove(n)):this}isEqual(t){if(!(t instanceof Qa)||this.size!==t.size)return!1;const n=this.sortedSet.getIterator(),s=t.sortedSet.getIterator();for(;n.hasNext();){const o=n.getNext().key,u=s.getNext().key;if(!o.isEqual(u))return!1}return!0}toString(){const t=[];return this.forEach((n=>{t.push(n.toString())})),t.length===0?"DocumentSet ()":`DocumentSet (
  `+t.join(`  
`)+`
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class _I{constructor(){this.wa=void 0,this.Sa=[]}ba(){return this.Sa.some((t=>t.Da()))}}class vI{constructor(){this.queries=Fv(),this.onlineState="Unknown",this.Ca=new Set}terminate(){(function(n,s){const o=St(n),u=o.queries;o.queries=Fv(),u.forEach(((f,m)=>{for(const y of m.Sa)y.onError(s)}))})(this,new at(Q.ABORTED,"Firestore shutting down"))}}function Fv(){return new Gs((r=>TE(r)),Kl)}async function TI(r,t){const n=St(r);let s=3;const o=t.query;let u=n.queries.get(o);u?!u.ba()&&t.Da()&&(s=2):(u=new _I,s=t.Da()?0:1);try{switch(s){case 0:u.wa=await n.onListen(o,!0);break;case 1:u.wa=await n.onListen(o,!1);break;case 2:await n.onFirstRemoteStoreListen(o)}}catch(f){const m=Gm(f,`Initialization of query '${qa(t.query)}' failed`);return void t.onError(m)}n.queries.set(o,u),u.Sa.push(t),t.va(n.onlineState),u.wa&&t.Fa(u.wa)&&Qm(n)}async function EI(r,t){const n=St(r),s=t.query;let o=3;const u=n.queries.get(s);if(u){const f=u.Sa.indexOf(t);f>=0&&(u.Sa.splice(f,1),u.Sa.length===0?o=t.Da()?0:1:!u.ba()&&t.Da()&&(o=2))}switch(o){case 0:return n.queries.delete(s),n.onUnlisten(s,!0);case 1:return n.queries.delete(s),n.onUnlisten(s,!1);case 2:return n.onLastRemoteStoreUnlisten(s);default:return}}function AI(r,t){const n=St(r);let s=!1;for(const o of t){const u=o.query,f=n.queries.get(u);if(f){for(const m of f.Sa)m.Fa(o)&&(s=!0);f.wa=o}}s&&Qm(n)}function SI(r,t,n){const s=St(r),o=s.queries.get(t);if(o)for(const u of o.Sa)u.onError(n);s.queries.delete(t)}function Qm(r){r.Ca.forEach((t=>{t.next()}))}var dm,Gv;(Gv=dm||(dm={})).Ma="default",Gv.Cache="cache";class bI{constructor(t,n,s){this.query=t,this.xa=n,this.Oa=!1,this.Na=null,this.onlineState="Unknown",this.options=s||{}}Fa(t){if(!this.options.includeMetadataChanges){const s=[];for(const o of t.docChanges)o.type!==3&&s.push(o);t=new no(t.query,t.docs,t.oldDocs,s,t.mutatedKeys,t.fromCache,t.syncStateChanged,!0,t.hasCachedResults)}let n=!1;return this.Oa?this.Ba(t)&&(this.xa.next(t),n=!0):this.La(t,this.onlineState)&&(this.ka(t),n=!0),this.Na=t,n}onError(t){this.xa.error(t)}va(t){this.onlineState=t;let n=!1;return this.Na&&!this.Oa&&this.La(this.Na,t)&&(this.ka(this.Na),n=!0),n}La(t,n){if(!t.fromCache||!this.Da())return!0;const s=n!=="Offline";return(!this.options.qa||!s)&&(!t.docs.isEmpty()||t.hasCachedResults||n==="Offline")}Ba(t){if(t.docChanges.length>0)return!0;const n=this.Na&&this.Na.hasPendingWrites!==t.hasPendingWrites;return!(!t.syncStateChanged&&!n)&&this.options.includeMetadataChanges===!0}ka(t){t=no.fromInitialDocuments(t.query,t.docs,t.mutatedKeys,t.fromCache,t.hasCachedResults),this.Oa=!0,this.xa.next(t)}Da(){return this.options.source!==dm.Cache}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class e0{constructor(t){this.key=t}}class n0{constructor(t){this.key=t}}class wI{constructor(t,n){this.query=t,this.Ya=n,this.Za=null,this.hasCachedResults=!1,this.current=!1,this.Xa=Mt(),this.mutatedKeys=Mt(),this.eu=EE(t),this.tu=new Qa(this.eu)}get nu(){return this.Ya}ru(t,n){const s=n?n.iu:new Hv,o=n?n.tu:this.tu;let u=n?n.mutatedKeys:this.mutatedKeys,f=o,m=!1;const y=this.query.limitType==="F"&&o.size===this.query.limit?o.last():null,p=this.query.limitType==="L"&&o.size===this.query.limit?o.first():null;if(t.inorderTraversal(((E,w)=>{const C=o.get(E),j=mh(this.query,w)?w:null,Z=!!C&&this.mutatedKeys.has(C.key),tt=!!j&&(j.hasLocalMutations||this.mutatedKeys.has(j.key)&&j.hasCommittedMutations);let X=!1;C&&j?C.data.isEqual(j.data)?Z!==tt&&(s.track({type:3,doc:j}),X=!0):this.su(C,j)||(s.track({type:2,doc:j}),X=!0,(y&&this.eu(j,y)>0||p&&this.eu(j,p)<0)&&(m=!0)):!C&&j?(s.track({type:0,doc:j}),X=!0):C&&!j&&(s.track({type:1,doc:C}),X=!0,(y||p)&&(m=!0)),X&&(j?(f=f.add(j),u=tt?u.add(E):u.delete(E)):(f=f.delete(E),u=u.delete(E)))})),this.query.limit!==null)for(;f.size>this.query.limit;){const E=this.query.limitType==="F"?f.last():f.first();f=f.delete(E.key),u=u.delete(E.key),s.track({type:1,doc:E})}return{tu:f,iu:s,Cs:m,mutatedKeys:u}}su(t,n){return t.hasLocalMutations&&n.hasCommittedMutations&&!n.hasLocalMutations}applyChanges(t,n,s,o){const u=this.tu;this.tu=t.tu,this.mutatedKeys=t.mutatedKeys;const f=t.iu.ya();f.sort(((E,w)=>(function(j,Z){const tt=X=>{switch(X){case 0:return 1;case 2:case 3:return 2;case 1:return 0;default:return pt(20277,{Rt:X})}};return tt(j)-tt(Z)})(E.type,w.type)||this.eu(E.doc,w.doc))),this.ou(s),o=o??!1;const m=n&&!o?this._u():[],y=this.Xa.size===0&&this.current&&!o?1:0,p=y!==this.Za;return this.Za=y,f.length!==0||p?{snapshot:new no(this.query,t.tu,u,f,t.mutatedKeys,y===0,p,!1,!!s&&s.resumeToken.approximateByteSize()>0),au:m}:{au:m}}va(t){return this.current&&t==="Offline"?(this.current=!1,this.applyChanges({tu:this.tu,iu:new Hv,mutatedKeys:this.mutatedKeys,Cs:!1},!1)):{au:[]}}uu(t){return!this.Ya.has(t)&&!!this.tu.has(t)&&!this.tu.get(t).hasLocalMutations}ou(t){t&&(t.addedDocuments.forEach((n=>this.Ya=this.Ya.add(n))),t.modifiedDocuments.forEach((n=>{})),t.removedDocuments.forEach((n=>this.Ya=this.Ya.delete(n))),this.current=t.current)}_u(){if(!this.current)return[];const t=this.Xa;this.Xa=Mt(),this.tu.forEach((s=>{this.uu(s.key)&&(this.Xa=this.Xa.add(s.key))}));const n=[];return t.forEach((s=>{this.Xa.has(s)||n.push(new n0(s))})),this.Xa.forEach((s=>{t.has(s)||n.push(new e0(s))})),n}cu(t){this.Ya=t.Qs,this.Xa=Mt();const n=this.ru(t.documents);return this.applyChanges(n,!0)}lu(){return no.fromInitialDocuments(this.query,this.tu,this.mutatedKeys,this.Za===0,this.hasCachedResults)}}const Km="SyncEngine";class RI{constructor(t,n,s){this.query=t,this.targetId=n,this.view=s}}class II{constructor(t){this.key=t,this.hu=!1}}class CI{constructor(t,n,s,o,u,f){this.localStore=t,this.remoteStore=n,this.eventManager=s,this.sharedClientState=o,this.currentUser=u,this.maxConcurrentLimboResolutions=f,this.Pu={},this.Tu=new Gs((m=>TE(m)),Kl),this.Iu=new Map,this.Eu=new Set,this.du=new se(ft.comparator),this.Au=new Map,this.Ru=new km,this.Vu={},this.mu=new Map,this.fu=eo.cr(),this.onlineState="Unknown",this.gu=void 0}get isPrimaryClient(){return this.gu===!0}}async function DI(r,t,n=!0){const s=l0(r);let o;const u=s.Tu.get(t);return u?(s.sharedClientState.addLocalQueryTarget(u.targetId),o=u.view.lu()):o=await i0(s,t,n,!0),o}async function NI(r,t){const n=l0(r);await i0(n,t,!0,!1)}async function i0(r,t,n,s){const o=await KR(r.localStore,hi(t)),u=o.targetId,f=r.sharedClientState.addLocalQueryTarget(u,n);let m;return s&&(m=await OI(r,t,u,f==="current",o.resumeToken)),r.isPrimaryClient&&n&&XE(r.remoteStore,o),m}async function OI(r,t,n,s,o){r.pu=(w,C,j)=>(async function(tt,X,st,ut){let rt=X.view.ru(st);rt.Cs&&(rt=await Uv(tt.localStore,X.query,!1).then((({documents:M})=>X.view.ru(M,rt))));const wt=ut&&ut.targetChanges.get(X.targetId),vt=ut&&ut.targetMismatches.get(X.targetId)!=null,Lt=X.view.applyChanges(rt,tt.isPrimaryClient,wt,vt);return Kv(tt,X.targetId,Lt.au),Lt.snapshot})(r,w,C,j);const u=await Uv(r.localStore,t,!0),f=new wI(t,u.Qs),m=f.ru(u.documents),y=Xl.createSynthesizedTargetChangeForCurrentChange(n,s&&r.onlineState!=="Offline",o),p=f.applyChanges(m,r.isPrimaryClient,y);Kv(r,n,p.au);const E=new RI(t,n,f);return r.Tu.set(t,E),r.Iu.has(n)?r.Iu.get(n).push(t):r.Iu.set(n,[t]),p.snapshot}async function VI(r,t,n){const s=St(r),o=s.Tu.get(t),u=s.Iu.get(o.targetId);if(u.length>1)return s.Iu.set(o.targetId,u.filter((f=>!Kl(f,t)))),void s.Tu.delete(t);s.isPrimaryClient?(s.sharedClientState.removeLocalQueryTarget(o.targetId),s.sharedClientState.isActiveQueryTarget(o.targetId)||await hm(s.localStore,o.targetId,!1).then((()=>{s.sharedClientState.clearQueryState(o.targetId),n&&Bm(s.remoteStore,o.targetId),mm(s,o.targetId)})).catch(oo)):(mm(s,o.targetId),await hm(s.localStore,o.targetId,!0))}async function MI(r,t){const n=St(r),s=n.Tu.get(t),o=n.Iu.get(s.targetId);n.isPrimaryClient&&o.length===1&&(n.sharedClientState.removeLocalQueryTarget(s.targetId),Bm(n.remoteStore,s.targetId))}async function PI(r,t,n){const s=qI(r);try{const o=await(function(f,m){const y=St(f),p=ee.now(),E=m.reduce(((j,Z)=>j.add(Z.key)),Mt());let w,C;return y.persistence.runTransaction("Locally write mutations","readwrite",(j=>{let Z=Wi(),tt=Mt();return y.Ns.getEntries(j,E).next((X=>{Z=X,Z.forEach(((st,ut)=>{ut.isValidDocument()||(tt=tt.add(st))}))})).next((()=>y.localDocuments.getOverlayedDocuments(j,Z))).next((X=>{w=X;const st=[];for(const ut of m){const rt=Qw(ut,w.get(ut.key).overlayedDocument);rt!=null&&st.push(new Qs(ut.key,rt,fE(rt.value.mapValue),fi.exists(!0)))}return y.mutationQueue.addMutationBatch(j,p,st,m)})).next((X=>{C=X;const st=X.applyToLocalDocumentSet(w,tt);return y.documentOverlayCache.saveOverlays(j,X.batchId,st)}))})).then((()=>({batchId:C.batchId,changes:SE(w)})))})(s.localStore,t);s.sharedClientState.addPendingMutation(o.batchId),(function(f,m,y){let p=f.Vu[f.currentUser.toKey()];p||(p=new se(Vt)),p=p.insert(m,y),f.Vu[f.currentUser.toKey()]=p})(s,o.batchId,n),await Zl(s,o.changes),await Th(s.remoteStore)}catch(o){const u=Gm(o,"Failed to persist write");n.reject(u)}}async function r0(r,t){const n=St(r);try{const s=await FR(n.localStore,t);t.targetChanges.forEach(((o,u)=>{const f=n.Au.get(u);f&&(Ht(o.addedDocuments.size+o.modifiedDocuments.size+o.removedDocuments.size<=1,22616),o.addedDocuments.size>0?f.hu=!0:o.modifiedDocuments.size>0?Ht(f.hu,14607):o.removedDocuments.size>0&&(Ht(f.hu,42227),f.hu=!1))})),await Zl(n,s,t)}catch(s){await oo(s)}}function Qv(r,t,n){const s=St(r);if(s.isPrimaryClient&&n===0||!s.isPrimaryClient&&n===1){const o=[];s.Tu.forEach(((u,f)=>{const m=f.view.va(t);m.snapshot&&o.push(m.snapshot)})),(function(f,m){const y=St(f);y.onlineState=m;let p=!1;y.queries.forEach(((E,w)=>{for(const C of w.Sa)C.va(m)&&(p=!0)})),p&&Qm(y)})(s.eventManager,t),o.length&&s.Pu.H_(o),s.onlineState=t,s.isPrimaryClient&&s.sharedClientState.setOnlineState(t)}}async function xI(r,t,n){const s=St(r);s.sharedClientState.updateQueryState(t,"rejected",n);const o=s.Au.get(t),u=o&&o.key;if(u){let f=new se(ft.comparator);f=f.insert(u,$e.newNoDocument(u,Et.min()));const m=Mt().add(u),y=new yh(Et.min(),new Map,new se(Vt),f,m);await r0(s,y),s.du=s.du.remove(u),s.Au.delete(t),Ym(s)}else await hm(s.localStore,t,!1).then((()=>mm(s,t,n))).catch(oo)}async function kI(r,t){const n=St(r),s=t.batch.batchId;try{const o=await HR(n.localStore,t);a0(n,s,null),s0(n,s),n.sharedClientState.updateMutationState(s,"acknowledged"),await Zl(n,o)}catch(o){await oo(o)}}async function UI(r,t,n){const s=St(r);try{const o=await(function(f,m){const y=St(f);return y.persistence.runTransaction("Reject batch","readwrite-primary",(p=>{let E;return y.mutationQueue.lookupMutationBatch(p,m).next((w=>(Ht(w!==null,37113),E=w.keys(),y.mutationQueue.removeMutationBatch(p,w)))).next((()=>y.mutationQueue.performConsistencyCheck(p))).next((()=>y.documentOverlayCache.removeOverlaysForBatchId(p,E,m))).next((()=>y.localDocuments.recalculateAndSaveOverlaysForDocumentKeys(p,E))).next((()=>y.localDocuments.getDocuments(p,E)))}))})(s.localStore,t);a0(s,t,n),s0(s,t),s.sharedClientState.updateMutationState(t,"rejected",n),await Zl(s,o)}catch(o){await oo(o)}}function s0(r,t){(r.mu.get(t)||[]).forEach((n=>{n.resolve()})),r.mu.delete(t)}function a0(r,t,n){const s=St(r);let o=s.Vu[s.currentUser.toKey()];if(o){const u=o.get(t);u&&(n?u.reject(n):u.resolve(),o=o.remove(t)),s.Vu[s.currentUser.toKey()]=o}}function mm(r,t,n=null){r.sharedClientState.removeLocalQueryTarget(t);for(const s of r.Iu.get(t))r.Tu.delete(s),n&&r.Pu.yu(s,n);r.Iu.delete(t),r.isPrimaryClient&&r.Ru.jr(t).forEach((s=>{r.Ru.containsKey(s)||o0(r,s)}))}function o0(r,t){r.Eu.delete(t.path.canonicalString());const n=r.du.get(t);n!==null&&(Bm(r.remoteStore,n),r.du=r.du.remove(t),r.Au.delete(n),Ym(r))}function Kv(r,t,n){for(const s of n)s instanceof e0?(r.Ru.addReference(s.key,t),LI(r,s)):s instanceof n0?(ot(Km,"Document no longer in limbo: "+s.key),r.Ru.removeReference(s.key,t),r.Ru.containsKey(s.key)||o0(r,s.key)):pt(19791,{wu:s})}function LI(r,t){const n=t.key,s=n.path.canonicalString();r.du.get(n)||r.Eu.has(s)||(ot(Km,"New document in limbo: "+n),r.Eu.add(s),Ym(r))}function Ym(r){for(;r.Eu.size>0&&r.du.size<r.maxConcurrentLimboResolutions;){const t=r.Eu.values().next().value;r.Eu.delete(t);const n=new ft(te.fromString(t)),s=r.fu.next();r.Au.set(s,new II(n)),r.du=r.du.insert(n,s),XE(r.remoteStore,new Pr(hi(Om(n.path)),s,"TargetPurposeLimboResolution",hh.ce))}}async function Zl(r,t,n){const s=St(r),o=[],u=[],f=[];s.Tu.isEmpty()||(s.Tu.forEach(((m,y)=>{f.push(s.pu(y,t,n).then((p=>{if((p||n)&&s.isPrimaryClient){const E=p?!p.fromCache:n?.targetChanges.get(y.targetId)?.current;s.sharedClientState.updateQueryState(y.targetId,E?"current":"not-current")}if(p){o.push(p);const E=Lm.As(y.targetId,p);u.push(E)}})))})),await Promise.all(f),s.Pu.H_(o),await(async function(y,p){const E=St(y);try{await E.persistence.runTransaction("notifyLocalViewChanges","readwrite",(w=>Y.forEach(p,(C=>Y.forEach(C.Es,(j=>E.persistence.referenceDelegate.addReference(w,C.targetId,j))).next((()=>Y.forEach(C.ds,(j=>E.persistence.referenceDelegate.removeReference(w,C.targetId,j)))))))))}catch(w){if(!lo(w))throw w;ot(zm,"Failed to update sequence numbers: "+w)}for(const w of p){const C=w.targetId;if(!w.fromCache){const j=E.Ms.get(C),Z=j.snapshotVersion,tt=j.withLastLimboFreeSnapshotVersion(Z);E.Ms=E.Ms.insert(C,tt)}}})(s.localStore,u))}async function zI(r,t){const n=St(r);if(!n.currentUser.isEqual(t)){ot(Km,"User change. New user:",t.toKey());const s=await GE(n.localStore,t);n.currentUser=t,(function(u,f){u.mu.forEach((m=>{m.forEach((y=>{y.reject(new at(Q.CANCELLED,f))}))})),u.mu.clear()})(n,"'waitForPendingWrites' promise is rejected due to a user change."),n.sharedClientState.handleUserChange(t,s.removedBatchIds,s.addedBatchIds),await Zl(n,s.Ls)}}function BI(r,t){const n=St(r),s=n.Au.get(t);if(s&&s.hu)return Mt().add(s.key);{let o=Mt();const u=n.Iu.get(t);if(!u)return o;for(const f of u){const m=n.Tu.get(f);o=o.unionWith(m.view.nu)}return o}}function l0(r){const t=St(r);return t.remoteStore.remoteSyncer.applyRemoteEvent=r0.bind(null,t),t.remoteStore.remoteSyncer.getRemoteKeysForTarget=BI.bind(null,t),t.remoteStore.remoteSyncer.rejectListen=xI.bind(null,t),t.Pu.H_=AI.bind(null,t.eventManager),t.Pu.yu=SI.bind(null,t.eventManager),t}function qI(r){const t=St(r);return t.remoteStore.remoteSyncer.applySuccessfulWrite=kI.bind(null,t),t.remoteStore.remoteSyncer.rejectFailedWrite=UI.bind(null,t),t}class Jc{constructor(){this.kind="memory",this.synchronizeTabs=!1}async initialize(t){this.serializer=_h(t.databaseInfo.databaseId),this.sharedClientState=this.Du(t),this.persistence=this.Cu(t),await this.persistence.start(),this.localStore=this.vu(t),this.gcScheduler=this.Fu(t,this.localStore),this.indexBackfillerScheduler=this.Mu(t,this.localStore)}Fu(t,n){return null}Mu(t,n){return null}vu(t){return jR(this.persistence,new zR,t.initialUser,this.serializer)}Cu(t){return new FE(Um.mi,this.serializer)}Du(t){return new XR}async terminate(){this.gcScheduler?.stop(),this.indexBackfillerScheduler?.stop(),this.sharedClientState.shutdown(),await this.persistence.shutdown()}}Jc.provider={build:()=>new Jc};class jI extends Jc{constructor(t){super(),this.cacheSizeBytes=t}Fu(t,n){Ht(this.persistence.referenceDelegate instanceof $c,46915);const s=this.persistence.referenceDelegate.garbageCollector;return new bR(s,t.asyncQueue,n)}Cu(t){const n=this.cacheSizeBytes!==void 0?an.withCacheSize(this.cacheSizeBytes):an.DEFAULT;return new FE((s=>$c.mi(s,n)),this.serializer)}}class gm{async initialize(t,n){this.localStore||(this.localStore=t.localStore,this.sharedClientState=t.sharedClientState,this.datastore=this.createDatastore(n),this.remoteStore=this.createRemoteStore(n),this.eventManager=this.createEventManager(n),this.syncEngine=this.createSyncEngine(n,!t.synchronizeTabs),this.sharedClientState.onlineStateHandler=s=>Qv(this.syncEngine,s,1),this.remoteStore.remoteSyncer.handleCredentialChange=zI.bind(null,this.syncEngine),await yI(this.remoteStore,this.syncEngine.isPrimaryClient))}createEventManager(t){return(function(){return new vI})()}createDatastore(t){const n=_h(t.databaseInfo.databaseId),s=(function(u){return new tI(u)})(t.databaseInfo);return(function(u,f,m,y){return new rI(u,f,m,y)})(t.authCredentials,t.appCheckCredentials,s,n)}createRemoteStore(t){return(function(s,o,u,f,m){return new aI(s,o,u,f,m)})(this.localStore,this.datastore,t.asyncQueue,(n=>Qv(this.syncEngine,n,0)),(function(){return Bv.v()?new Bv:new $R})())}createSyncEngine(t,n){return(function(o,u,f,m,y,p,E){const w=new CI(o,u,f,m,y,p);return E&&(w.gu=!0),w})(this.localStore,this.remoteStore,this.eventManager,this.sharedClientState,t.initialUser,t.maxConcurrentLimboResolutions,n)}async terminate(){await(async function(n){const s=St(n);ot(Us,"RemoteStore shutting down."),s.Ea.add(5),await $l(s),s.Aa.shutdown(),s.Ra.set("Unknown")})(this.remoteStore),this.datastore?.terminate(),this.eventManager?.terminate()}}gm.provider={build:()=>new gm};/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const th=new uh("@firebase/auth");function yC(r,...t){th.logLevel<=Ot.WARN&&th.warn(`Auth (${so}): ${r}`,...t)}function Uc(r,...t){th.logLevel<=Ot.ERROR&&th.error(`Auth (${so}): ${r}`,...t)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const SC=["/v1/accounts:signInWithCustomToken","/v1/accounts:signInWithEmailLink","/v1/accounts:signInWithIdp","/v1/accounts:signInWithPassword","/v1/accounts:signInWithPhoneNumber","/v1/token"],bC=new Jl(3e4,6e4);function fg(r,t){return r.tenantId&&!t.tenantId?{...t,tenantId:r.tenantId}:t}async function ho(r,t,n,s,o={}){return C0(r,o,async()=>{let u={},f={};s&&(t==="GET"?f=s:u={body:JSON.stringify(s)});const m=Gl({key:r.config.apiKey,...f}).slice(1),y=await r._getAdditionalHeaders();y["Content-Type"]="application/json",r.languageCode&&(y["X-Firebase-Locale"]=r.languageCode);const p={method:t,headers:y,...u};return bb()||(p.referrerPolicy="no-referrer"),r.emulatorConfig&&ro(r.emulatorConfig.host)&&(p.credentials="include"),I0.fetch()(await D0(r,r.config.apiHost,n,m),p)})}async function C0(r,t,n){r._canInitEmulator=!1;const s={...AC,...t};try{const o=new RC(r),u=await Promise.race([n(),o.promise]);o.clearNetworkTimeout();const f=await u.json();if("needConfirmation"in f)throw Nc(r,"account-exists-with-different-credential",f);if(u.ok&&!("errorMessage"in f))return f;{const m=u.ok?f.errorMessage:f.error.message,[y,p]=m.split(" : ");if(y==="FEDERATED_USER_ID_ALREADY_LINKED")throw Nc(r,"credential-already-in-use",f);if(y==="EMAIL_EXISTS")throw Nc(r,"email-already-in-use",f);if(y==="USER_DISABLED")throw Nc(r,"user-disabled",f);const E=s[y]||y.toLowerCase().replace(/[_\s]+/g,"-");if(p)throw ug(r,E,p);Ei(r,E)}}catch(o){if(o instanceof Qn)throw o;Ei(r,"network-request-failed",{message:String(o)})}}async function wC(r,t,n,s,o={}){const u=await ho(r,t,n,s,o);return"mfaPendingCredential"in u&&Ei(r,"multi-factor-auth-required",{_serverResponse:u}),u}async function D0(r,t,n,s){const o=`${t}${n}?${s}`,u=r,f=u.config.emulator?hg(r.config,o):`${r.config.apiScheme}://${o}`;return SC.includes(n)&&(await u._persistenceManagerAvailable,u._getPersistenceType()==="COOKIE")?u._getPersistence()._getFinalTarget(f).toString():f}class RC{clearNetworkTimeout(){clearTimeout(this.timer)}constructor(t){this.auth=t,this.timer=null,this.promise=new Promise((n,s)=>{this.timer=setTimeout(()=>s(Hn(this.auth,"network-request-failed")),bC.get())})}}function Nc(r,t,n){const s={appName:r.name};n.email&&(s.email=n.email),n.phoneNumber&&(s.phoneNumber=n.phoneNumber);const o=Hn(r,t,s);return o.customData._tokenResponse=n,o}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function WC(r,t,n=!1){const{auth:s}=r;if(Bn(s.app))return Promise.reject(xs(s));const o="reauthenticate";try{const u=await Fl(r,H0(s,o,t,r),n);_t(u.idToken,s,"internal-error");const f=dg(u.idToken);_t(f,s,"internal-error");const{sub:m}=f;return _t(r.uid===m,s,"user-mismatch"),io._forOperation(r,o,u)}catch(u){throw u?.code==="auth/user-not-found"&&Ei(s,"user-mismatch"),u}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class W0{constructor(t,n,s,o,u=!1){this.auth=t,this.resolver=s,this.user=o,this.bypassAuthState=u,this.pendingPromise=null,this.eventManager=null,this.filter=Array.isArray(n)?n:[n]}execute(){return new Promise(async(t,n)=>{this.pendingPromise={resolve:t,reject:n};try{this.eventManager=await this.resolver._initialize(this.auth),await this.onExecution(),this.eventManager.registerConsumer(this)}catch(s){this.reject(s)}})}async onAuthEvent(t){const{urlResponse:n,sessionId:s,postBody:o,tenantId:u,error:f,type:m}=t;if(f){this.reject(f);return}const y={auth:this.auth,requestUri:n,sessionId:s,tenantId:u||void 0,postBody:o||void 0,user:this.user,bypassAuthState:this.bypassAuthState};try{this.resolve(await this.getIdpTask(m)(y))}catch(p){this.reject(p)}}onError(t){this.reject(t)}getIdpTask(t){switch(t){case"signInViaPopup":case"signInViaRedirect":return T2;case"linkViaPopup":case"linkViaRedirect":return A2;case"reauthViaPopup":case"reauthViaRedirect":return E2;default:Ei(this.auth,"internal-error")}}resolve(t){tr(this.pendingPromise,"Pending promise was never set"),this.pendingPromise.resolve(t),this.unregisterAndCleanUp()}reject(t){tr(this.pendingPromise,"Pending promise was never set"),this.pendingPromise.reject(t),this.unregisterAndCleanUp()}unregisterAndCleanUp(){this.eventManager&&this.eventManager.unregisterConsumer(this),this.pendingPromise=null,this.cleanUp()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function cD(r){switch(r){case"Node":return"node";case"ReactNative":return"rn";case"Worker":return"webworker";case"Cordova":return"cordova";case"WebExtension":return"web-extension";default:return}}function hD(r){_i(new Fn("auth",(t,{options:n})=>{const s=t.getProvider("app").getImmediate(),o=t.getProvider("heartbeat"),u=t.getProvider("app-check-internal"),{apiKey:f,authDomain:m}=s.options;_t(f&&!f.includes(":"),"invalid-api-key",{appName:s.name});const y={apiKey:f,authDomain:m,clientPlatform:r,apiHost:"identitytoolkit.googleapis.com",tokenApiHost:"securetoken.googleapis.com",apiScheme:"https",sdkClientVersion:B0(r)},p=new qC(s,o,u,y);return KC(p,n),p},"PUBLIC").setInstantiationMode("EXPLICIT").setInstanceCreatedCallback((t,n,s)=>{t.getProvider("auth-internal").initialize()})),_i(new Fn("auth-internal",t=>{const n=Ah(t.getProvider("auth").getImmediate());return(s=>new uD(s))(n)},"PRIVATE").setInstantiationMode("EXPLICIT")),Mn(vT,TT,cD(r)),Mn(vT,TT,"esm2020")}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
OTHER TORTIOUS ACTION, ARISING OUT OF OR IN CONNECTION WITH THE USE OR
PERFORMANCE OF THIS SOFTWARE.
***************************************************************************** */var Fa=function(){return Fa=Object.assign||function(t){for(var n,s=1,o=arguments.length;s<o;s++){n=arguments[s];for(var u in n)Object.prototype.hasOwnProperty.call(n,u)&&(t[u]=n[u])}return t},Fa.apply(this,arguments)},SA=function(r){return{loading:r==null,value:r}},LN=function(){return function(r,t){switch(t.type){case"error":return Fa(Fa({},r),{error:t.error,loading:!1,value:void 0});case"reset":return SA(t.defaultValue);case"value":return Fa(Fa({},r),{error:void 0,loading:!1,value:t.value});default:return r}}},zN=(function(r){var t=r?r():void 0,n=At.useReducer(LN(),SA(t)),s=n[0],o=n[1],u=At.useCallback(function(){var y=r?r():void 0;o({type:"reset",defaultValue:y})},[r]),f=At.useCallback(function(y){o({type:"error",error:y})},[]),m=At.useCallback(function(y){o({type:"value",value:y})},[]);return At.useMemo(function(){return{error:s.error,loading:s.loading,reset:u,setError:f,setValue:m,value:s.value}},[s.error,s.loading,u,f,m,s.value])}),bA=(function(r,t){var n=zN(function(){return r.currentUser}),s=n.error,o=n.loading,u=n.setError,f=n.setValue,m=n.value;return At.useEffect(function(){var y=i2(r,function(p){return kN(void 0,void 0,void 0,function(){var E;return UN(this,function(w){switch(w.label){case 0:return[3,4];case 1:return w.trys.push([1,3,,4]),[4,t.onUserChanged(p)];case 2:return w.sent(),[3,4];case 3:return E=w.sent(),u(E),[3,4];case 4:return f(p),[2]}})})},u);return function(){y()}},[r]),[m,o,s]});/*! *****************************************************************************
Copyright (c) Microsoft Corporation.
...
OTHER TORTIOUS ACTION, ARISING OUT OF OR IN CONNECTION WITH THE USE OR
PERFORMANCE OF THIS SOFTWARE.
***************************************************************************** */var Ga=function(){return Ga=Object.assign||function(t){for(var n,s=1,o=arguments.length;s<o;s++){n=arguments[s];for(var u in n)Object.prototype.hasOwnProperty.call(n,u)&&(t[u]=n[u])}return t},Ga.apply(this,arguments)},wA=function(r){return{loading:r==null,value:r}},BN=function(){return function(r,t){switch(t.type){case"error":return Ga(Ga({},r),{error:t.error,loading:!1,value:void 0});case"reset":return wA(t.defaultValue);case"value":return Ga(Ga({},r),{error:void 0,loading:!1,value:t.value});default:return r}}},RA=(function(r){var t=void 0,n=At.useReducer(BN(),wA(t)),s=n[0],o=n[1],u=At.useCallback(function(){var y=void 0;o({type:"reset",defaultValue:y})},[r]),f=At.useCallback(function(y){o({type:"error",error:y})},[]),m=At.useCallback(function(y){o({type:"value",value:y})},[]);return At.useMemo(function(){return{error:s.error,loading:s.loading,reset:u,setError:f,setValue:m,value:s.value}},[s.error,s.loading,u,f,m,s.value])}),IA=function(r,t,n){var s=At.useRef(r);return At.useEffect(function(){t(r,s.current)||(s.current=r,n&&n())}),s},qN=function(r,t){var n=!r&&!t,s=!!r&&!!t&&XI(r,t);return n||s},jN=function(r,t){return IA(r,qN,t)},HN=function(r,t){var n=!r&&!t,s=!!r&&!!t&&$I(r,t);return n||s},FN=function(r,t){return IA(r,HN,t)},GN=function(r,t){var n=RA(),s=n.error,o=n.loading,u=n.reset,f=n.setError,m=n.setValue,y=n.value,p=FN(r,u);return At.useEffect(function(){if(!p.current){m(void 0);return}var E=t?.snapshotListenOptions?pm(p.current,t.snapshotListenOptions,m,f):pm(p.current,m,f);return function(){E()}},[p.current]),[y,o,s]},QN=function(r,t){var n=GN(r,t),s=n[0],o=n[1],u=n[2],f=KN(s,t?.snapshotOptions,t?.initialValue);return[f,o,u,s]},KN=function(r,t,n){return At.useMemo(function(){var s;return(s=r?.docs.map(function(o){return o.data(t)}))!==null&&s!==void 0?s:n},[r,t])},YN=function(r,t){var n=RA(),s=n.error,o=n.loading,u=n.reset,f=n.setError,m=n.setValue,y=n.value,p=jN(r,u);return At.useEffect(function(){if(!p.current){m(void 0);return}var E=pm(p.current,m,f);return function(){E()}},[p.current]),[y,o,s]};const XN={apiKey:"AIzaSyBQSuvCd5mb-lbvoaZrwGl7fXhFRZWI0ZU",authDomain:"neshaybahs-chatroom.firebaseapp.com",projectId:"neshaybahs-chatroom",storageBucket:"neshaybahs-chatroom.firebasestorage.app",messagingSenderId:"120115708605",appId:"1:120115708605:web:b2956f68690d946f5badd4"},bg=FT(XN),qs=gD(bg),wg=ZI(bg);VN(bg);const $N="dssbbkavm",ZN="chat_uploads",JN=()=>{const r=At.useRef(null),[t,n]=At.useState([]),[s,o]=At.useState(0),[u,f]=At.useState(!1),[m,y]=At.useState(0),[p,E]=At.useState(0),w=st=>{const rt=st.replace(".mp3","").split(" - ");return`${(rt.length>1?rt[1]:rt[0]).toLowerCase().replace(/'/g,"").replace(/[^a-z0-9\s]/g,"").replace(/\s+/g,"-").trim()}.png`};At.useEffect(()=>{const ut=["Jeff Buckley - Lover You Shouldve Come Over.mp3","wifiskeletton - Nope your too late i already died.mp3"].map(rt=>{const[wt,vt]=rt.replace(".mp3","").split(" - "),Lt=w(rt);return{filename:rt,artist:wt||"Unknown Artist",songName:vt||"Unknown Song",url:`/neshaybahs-chatroom/music/${encodeURIComponent(rt)}`,albumCover:`/neshaybahs-chatroom/album-covers/${encodeURIComponent(Lt)}`}});n(ut)},[]),At.useEffect(()=>{const st=r.current;if(!st)return;const ut=()=>y(st.currentTime),rt=()=>E(st.duration),wt=()=>j();return st.addEventListener("timeupdate",ut),st.addEventListener("durationchange",rt),st.addEventListener("ended",wt),()=>{st.removeEventListener("timeupdate",ut),st.removeEventListener("durationchange",rt),st.removeEventListener("ended",wt)}},[]),At.useEffect(()=>{t.length>0&&r.current&&(r.current.src=t[s]?.url)},[s,t]);const C=()=>{!r.current||t.length===0||(u?r.current.pause():r.current.play().catch(console.error),f(!u))},j=()=>{t.length!==0&&(o(st=>(st+1)%t.length),f(!0))},Z=()=>{t.length!==0&&(o(st=>(st-1+t.length)%t.length),f(!0))},tt=()=>t[s]||{artist:"No Artist",songName:"No Song",url:"",albumCover:"https://i.scdn.co/image/ab67616d0000b27398b1c6c0d05f8841f08a9eca"},X=st=>{r.current&&p&&(r.current.currentTime=st,y(st))};return{audioRef:r,playlist:t,currentTrack:tt(),isPlaying:u,currentTime:m,duration:p,togglePlayPause:C,nextTrack:j,previousTrack:Z,setCurrentTrackIndex:o,seekTo:X}},WN=async(r,t)=>{try{const n=Xm(wg,"userProfiles",r);return await dC(n,{...t,updatedAt:b0()},{merge:!0}),!0}catch(n){return console.error("Error updating user profile:",n),!1}},tO=(r,t)=>({displayName:r?.displayName||t?.displayName||"Anonymous",photoURL:r?.photoURL||t?.photoURL||null}),CA=r=>{const t=r?Xm(wg,"userProfiles",r.uid):null,[n,s,o]=YN(t),[u,f]=At.useState({displayName:"Anonymous",photoURL:null});At.useEffect(()=>{if(r){const y=n?.data(),p={displayName:r.displayName,photoURL:r.photoURL},E=tO(y,p);f(E)}},[r,n]);const m=async y=>r?await WN(r.uid,y):!1;return{customProfile:n?.data()||null,displayData:u,loading:s,error:o,updateProfile:m}},eO=async(r,t)=>{try{if(r.size>10*1024*1024)throw new Error("File size exceeds 10MB limit");if(!r.type.startsWith("image/"))throw new Error("File must be an image");const n=new FormData;n.append("file",r),n.append("upload_preset",ZN);const s=t.replace(/[^a-zA-Z0-9]/g,"");n.append("folder",`chat_images/${s}`);const o=Date.now(),u=r.name.split(".")[0].replace(/[^a-zA-Z0-9]/g,"_");n.append("public_id",`${o}_${u}`);const f=await fetch(`https://api.cloudinary.com/v1_1/${$N}/image/upload`,{method:"POST",body:n}),m=await f.text();if(!f.ok){console.error(`HTTP error! status: ${f.status}, response: ${m}`);try{const p=JSON.parse(m);throw new Error(p.error?.message||`HTTP ${f.status}: ${m}`)}catch{throw new Error(`HTTP ${f.status}: ${m}`)}}const y=JSON.parse(m);if(y.secure_url)return{success:!0,url:y.secure_url,publicId:y.public_id,fileName:y.original_filename};throw new Error(y.error?.message||"Upload failed - no secure_url returned")}catch(n){return console.error("Error uploading image to Cloudinary:",n),n.message.includes("Invalid upload preset")?{success:!1,error:"Upload preset 'chat_uploads' not found or not configured properly in Cloudinary"}:n.message.includes("Invalid cloud name")?{success:!1,error:"Cloud name 'dssbbkavm' not found in Cloudinary"}:n.message.includes("Unauthorized")?{success:!1,error:"Upload preset is not configured for unsigned uploads"}:{success:!1,error:n.message||"Failed to upload image to Cloudinary"}}};function nO({file:r,onRemove:t}){const[n,s]=At.useState(null);return At.useEffect(()=>{if(r){const o=new FileReader;o.onloadend=()=>{s(o.result)},o.readAsDataURL(r)}return()=>{n&&URL.revokeObjectURL(n)}},[r]),n?J.jsxs("div",{className:"image-preview",children:[J.jsx("img",{src:n,alt:"Preview"}),J.jsx("button",{className:"remove-preview-btn",onClick:t,type:"button",children:J.jsx("i",{className:"bi bi-x"})})]}):null}function iO(){const[r]=bA(qs),[t,n]=At.useState(!1);return At.useEffect(()=>{const s=()=>{const o=window.innerHeight*.01;document.documentElement.style.setProperty("--vh",`${o}px`)};return s(),window.addEventListener("resize",s),window.addEventListener("orientationchange",s),()=>{window.removeEventListener("resize",s),window.removeEventListener("orientationchange",s)}},[]),J.jsxs("div",{className:"App",children:[J.jsxs("header",{children:[J.jsx("h1",{children:"NeshayBahs Chatroom"}),J.jsxs("div",{className:"d-flex gap-2",children:[r&&J.jsxs("button",{className:"btn btn-outline-light",onClick:()=>n(!0),children:[J.jsx("i",{className:"bi bi-gear me-2"}),"Settings"]}),J.jsx(aO,{})]})]}),J.jsx("div",{className:`chat-container container-fluid ${r?"has-user":""}`,children:r?J.jsx(lO,{}):J.jsx(sO,{})}),t&&J.jsxs(J.Fragment,{children:[J.jsx("div",{className:"settings-overlay",onClick:()=>n(!1)}),J.jsxs("div",{className:"settings-panel open",children:[J.jsxs("div",{className:"d-flex justify-content-between align-items-center mb-4",children:[J.jsx("h4",{children:"Settings"}),J.jsx("button",{className:"btn-close btn-close-white",onClick:()=>n(!1)})]}),r&&J.jsx(rO,{user:r,onClose:()=>n(!1)})]})]})]})}function rO({user:r,onClose:t}){const{customProfile:n,displayData:s,updateProfile:o}=CA(r),[u,f]=At.useState(!1),[m,y]=At.useState(""),[p,E]=At.useState(""),[w,C]=At.useState(!1);At.useEffect(()=>{u&&(y(n?.displayName||""),E(n?.photoURL||""))},[u,n]);const j=async()=>{C(!0);const tt={};m.trim()&&(tt.displayName=m.trim()),p.trim()&&(tt.photoURL=p.trim()),await o(tt)?f(!1):alert("Failed to update profile. Please try again."),C(!1)},Z=async()=>{window.confirm("Reset to Google profile data?")&&(C(!0),await o({displayName:null,photoURL:null})&&f(!1),C(!1))};return u?J.jsx("div",{className:"profile-section",children:J.jsxs("div",{className:"profile-editor",children:[J.jsx("h5",{className:"mb-3",children:"Edit Profile"}),J.jsxs("div",{className:"mb-3",children:[J.jsx("label",{className:"form-label",children:"Display Name"}),J.jsx("input",{type:"text",className:"form-control",value:m,onChange:tt=>y(tt.target.value),placeholder:r?.displayName||"Enter display name"})]}),J.jsxs("div",{className:"mb-3",children:[J.jsx("label",{className:"form-label",children:"Profile Picture URL"}),J.jsx("input",{type:"url",className:"form-control",value:p,onChange:tt=>E(tt.target.value),placeholder:r?.photoURL||"Enter image URL"}),p&&J.jsxs("div",{className:"mt-2",children:[J.jsx("small",{className:"text-muted",children:"Preview:"}),J.jsx("br",{}),J.jsx("img",{src:p,alt:"Preview",className:"profile-avatar mt-1",onError:tt=>{tt.target.style.display="none"}})]})]}),J.jsxs("div",{className:"d-flex gap-2 flex-wrap",children:[J.jsx("button",{className:"btn btn-primary",onClick:j,disabled:w,children:w?"Saving...":"Save"}),J.jsx("button",{className:"btn btn-secondary",onClick:()=>f(!1),disabled:w,children:"Cancel"}),n?.displayName&&J.jsx("button",{className:"btn btn-outline-warning",onClick:Z,disabled:w,children:"Reset to Google"})]})]})}):J.jsx("div",{className:"profile-section",children:J.jsxs("div",{className:"profile-display",children:[J.jsxs("div",{className:"d-flex align-items-center gap-3 mb-3",children:[J.jsx("img",{src:s.photoURL||`https://ui-avatars.com/api/?name=${encodeURIComponent(s.displayName)}`,alt:"Profile",className:"profile-avatar"}),J.jsxs("div",{children:[J.jsx("h5",{className:"mb-0",children:s.displayName}),J.jsx("small",{children:n?.displayName?"Custom Profile":"Using Google Profile"})]})]}),J.jsxs("button",{className:"btn btn-outline-light btn-sm",onClick:()=>f(!0),children:[J.jsx("i",{className:"bi bi-pencil me-2"}),"Edit Profile"]})]})})}function sO(){const r=async()=>{const t=new Yi;await b2(qs,t)};return J.jsxs("div",{className:"signin-container text-center mt-5",children:[J.jsxs("button",{className:"btn btn-outline-light",onClick:r,children:[J.jsx("i",{className:"bi bi-google me-2"})," Sign in with Google"]}),J.jsx("p",{className:"mt-2",children:"Made by NeshayBah w/ vibe coding"})]})}function aO(){return qs.currentUser&&J.jsxs("button",{className:"sign-out btn btn-outline-light",onClick:()=>r2(qs),children:[J.jsx("i",{className:"bi bi-box-arrow-right me-2"})," Sign Out"]})}function oO(){const{audioRef:r,currentTrack:t,isPlaying:n,togglePlayPause:s,nextTrack:o,previousTrack:u}=JN(),f="https://i.scdn.co/image/ab67616d0000b27398b1c6c0d05f8841f08a9eca",m=y=>{y.target.src=f};return J.jsxs("div",{className:"media-controls",children:[J.jsx("audio",{ref:r}),J.jsx("img",{src:t.albumCover,alt:"Album Cover",className:"album-cover",onError:m}),J.jsxs("div",{className:"media-text",children:[J.jsx("p",{className:"song-name",children:t.songName}),J.jsx("p",{className:"artist-name",children:t.artist})]}),J.jsxs("div",{className:"button-group",children:[J.jsx("button",{className:"skip-back",onClick:u,children:J.jsx("i",{className:"bi bi-skip-start"})}),J.jsx("button",{className:"play-pause",onClick:s,children:J.jsx("i",{className:`bi bi-${n?"pause":"play"}`})}),J.jsx("button",{className:"skip-forward",onClick:o,children:J.jsx("i",{className:"bi bi-skip-end"})})]})]})}function lO(){const r=At.useRef(),t=At.useRef(),n=YI(wg,"messages"),[s]=bA(qs),{displayData:o}=CA(s),u=lC(n,uC("createdAt"),cC(100)),[f]=QN(u,{}),[m,y]=At.useState(""),[p,E]=At.useState(null),[w,C]=At.useState(!1);At.useEffect(()=>{r.current&&r.current.scrollIntoView({behavior:"smooth"})},[f]);const j=X=>{const st=X.target.files[0];if(st){if(st.size>10*1024*1024){alert("File size too large. Please select an image under 10MB.");return}if(!st.type.startsWith("image/")){alert("Please select an image file.");return}E(st)}},Z=()=>{E(null),t.current&&(t.current.value="")},tt=async X=>{if(X.preventDefault(),!m.trim()&&!p)return;C(!0);const{uid:st}=qs.currentUser;let ut=null;try{if(p){const wt=await eO(p,st);if(wt.success)ut=wt.url;else{alert("Failed to upload image: "+wt.error),C(!1);return}}const rt={createdAt:b0(),uid:st,photoURL:o.photoURL||null,displayName:o.displayName||"Anonymous"};m.trim()&&(rt.text=m.trim()),ut?(rt.imageUrl=ut,rt.messageType="image"):rt.messageType="text",await mC(n,rt),y(""),E(null),t.current&&(t.current.value="")}catch(rt){console.error("Error sending message:",rt),rt.code==="permission-denied"?alert("Permission denied. Check your Firestore security rules."):rt.code==="unavailable"?alert("Firestore is currently unavailable. Please try again."):alert(`Error: ${rt.message}`)}finally{C(!1)}};return J.jsxs(J.Fragment,{children:[J.jsx(oO,{}),J.jsx("div",{className:"chat-panel d-flex flex-column",children:J.jsxs("div",{className:"messages-container flex-grow-1",children:[J.jsxs("main",{className:"messages-list",children:[f&&f.map(X=>J.jsx(uO,{message:X},X.id)),J.jsx("span",{ref:r})]}),p&&J.jsx("div",{className:"image-preview-container",children:J.jsx(nO,{file:p,onRemove:Z})}),J.jsxs("form",{onSubmit:tt,className:"chat-form",children:[J.jsx("input",{value:m,onChange:X=>y(X.target.value),placeholder:"Message something dude",disabled:w}),J.jsx("input",{type:"file",ref:t,onChange:j,accept:"image/*",style:{display:"none"}}),J.jsx("button",{type:"button",className:"image-upload-btn",onClick:()=>t.current?.click(),disabled:w,children:J.jsx("i",{className:"bi bi-image"})}),J.jsx("button",{type:"submit",disabled:!m.trim()&&!p||w,children:w?J.jsx("i",{className:"bi bi-hourglass-split"}):J.jsx("i",{className:"bi bi-send-fill"})})]})]})})]})}function uO({message:r}){const{text:t,uid:n,photoURL:s,displayName:o,createdAt:u,imageUrl:f,messageType:m}=r,y=n===qs.currentUser.uid?"sent":"received",[p,E]=At.useState(!0),[w,C]=At.useState(!1),j=X=>X?(X.toDate?X.toDate():new Date(X)).toLocaleTimeString([],{hour:"2-digit",minute:"2-digit"}):"",Z=()=>{E(!1)},tt=()=>{E(!1),C(!0)};return J.jsxs("div",{className:`message ${y}`,children:[J.jsx("img",{src:s||"https://ui-avatars.com/api/?name="+encodeURIComponent(o||"User"),alt:"avatar",className:"user-avatar"}),J.jsxs("div",{className:"message-content",children:[J.jsxs("div",{className:"message-header",children:[J.jsx("span",{className:"message-timestamp",children:j(u)}),J.jsx("strong",{children:o||"Unknown"})]}),t&&J.jsx("p",{children:t}),f&&J.jsxs("div",{className:"message-image-container",children:[p&&J.jsxs("div",{className:"image-loading",children:[J.jsx("i",{className:"bi bi-hourglass-split"}),J.jsx("span",{children:"Loading image..."})]}),w?J.jsxs("div",{className:"image-error",children:[J.jsx("i",{className:"bi bi-exclamation-triangle"}),J.jsx("span",{children:"Failed to load image"})]}):J.jsx("img",{src:f,alt:"Shared image",className:"message-image",onLoad:Z,onError:tt,style:{display:p?"none":"block"}})]})]})]})}lb.createRoot(document.getElementById("root")).render(J.jsx(At.StrictMode,{children:J.jsx(iO,{})}));
